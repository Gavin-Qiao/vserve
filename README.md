...
![vLLM 0.20–0.21](https://img.shields.io/badge/vLLM-0.20%E2%80%930.21-ff6f00?style=flat-square)
...
| Requirement | Check | Install |
|:------------|:------|:--------|
| stable vLLM 0.20.x or 0.21.x | `vserve runtime check vllm` | `vserve runtime upgrade vllm --stable` or [docs.vllm.ai](https://docs.vllm.ai/en/latest/getting_started/installation.html) |
